...
bool QGeoPositionInfoSourceGeoclueMaster::configurePositionSource()
{
    ...
    case NonSatellitePositioningMethods:
        return m_master->createMasterClient(Accuracy::None, QGeoclueMaster::ResourceCell | QGeoclueMaster::ResourceNetwork);
    case AllPositioningMethods:
        return m_master->createMasterClient(Accuracy::None, QGeoclueMaster::ResourceAll);
    default:
...
#include "moc_qgeopositioninfosource_geocluemaster.cpp"
